...
def mapDisplay(map):
	#图像的名称转换，包含6种不同的状态
	homeImageFile = r"res/image/1.jpg"
	bornPointImageFile = r"res/image/2.jpg"
	zeroImageFile = r"res/image/3.jpg"
	oneImageFile = r"res/image/4.jpg"
	twoImageFile = r"res/image/1.jpg"
	threeImageFile = r"res/image/2.jpg"
	backGroundFile = r"res/image/background.jpg"
