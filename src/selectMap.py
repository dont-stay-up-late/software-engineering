...
def selectMap(screen, clock, modeID):
    ...
    # 图片及位置
    bg = pygame.image.load("res/bg/bg_map.png").convert()
    ...
    homePos = (150, 0)
    mapTitle = pygame.image.load("res/pic/mapselecttitle.png").convert_alpha()
    mapTitlePos = (340, 0)
    modeIntro = pygame.image.load(modeintroadd).convert_alpha()
    modeintroPos = (980, 0)
    mapnum1Button = pygame.image.load("res/mapnum/Mapnum1_0.png").convert_alpha()
    mapnum1Pos = (365, 250)
    mapnum2Button = pygame.image.load("res/mapnum/Mapnum2_0.png").convert_alpha()
    mapnum2Pos = (565, 250)
    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_0.png").convert_alpha()
    mapnum3Pos = (765, 250)
    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
    mapnum4Pos = (365, 450)
    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
    mapnum5Pos = (565, 450)
    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
    mapnum6Pos = (765, 450)
    sureButton = pygame.image.load("res/button/sure.png").convert_alpha()
    surePos = (1080, 653)
    mapinfoPos = (0, 100)
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                if x > mapnum1Pos[0] and x < mapnum1Pos[0] + mapnum1Button.get_width() \
                    ...
                    mapnum1Button = pygame.image.load("res/mapnum/Mapnum1_1.png").convert_alpha()
                    mapnum2Button = pygame.image.load("res/mapnum/Mapnum2_0.png").convert_alpha()
                    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_0.png").convert_alpha()
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
                    # 地图信息
                    mapinfoID = "res/mapinfo/Map" + str(modeID) + "_1info.png"
                ...
                if x > mapnum2Pos[0] and x < mapnum2Pos[0] + mapnum2Button.get_width() \
                    ...
                    mapnum1Button = pygame.image.load("res/mapnum/Mapnum1_0.png").convert_alpha()
                    mapnum2Button = pygame.image.load("res/mapnum/Mapnum2_1.png").convert_alpha()
                    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_0.png").convert_alpha()
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
                    mapinfoID = "res/mapinfo/Map" + str(modeID) + "_2info.png"
                    mapinfo = pygame.image.load(mapinfoID).convert_alpha()
                    flag_mapinfo = 2
                # shift picture
                ...
                if x > mapnum3Pos[0] and x < mapnum3Pos[0] + mapnum3Button.get_width() \
                    ...
                    mapnum1Button = pygame.image.load("res/mapnum/Mapnum1_0.png").convert_alpha()
                    mapnum2Button = pygame.image.load("res/mapnum/Mapnum2_0.png").convert_alpha()
                    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_1.png").convert_alpha()
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
                    mapinfoID = "res/mapinfo/Map" + str(modeID) + "_3info.png"
                    mapinfo = pygame.image.load(mapinfoID).convert_alpha()
                    flag_mapinfo = 3
                # shift picture
                ...
                if x > mapnum4Pos[0] and x < mapnum4Pos[0] + mapnum4Button.get_width() \
                    ...
                    mapnum2Button = pygame.image.load("res/mapnum/Mapnum2_0.png").convert_alpha()
                    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_0.png").convert_alpha()
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_1.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
                ...
                if x > mapnum5Pos[0] and x < mapnum5Pos[0] + mapnum5Button.get_width() \
                    ...
                    mapnum3Button = pygame.image.load("res/mapnum/Mapnum3_0.png").convert_alpha()
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_1.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_0.png").convert_alpha()
                    mapinfoID = "res/mapinfo/Map" + str(modeID) + "_5info.png"
                    mapinfo = pygame.image.load(mapinfoID).convert_alpha()
                    flag_mapinfo = 5
                # shift picture
                ...
                if x > mapnum6Pos[0] and x < mapnum6Pos[0] + mapnum6Button.get_width() \
                    ...
                    mapnum4Button = pygame.image.load("res/mapnum/Mapnum4_0.png").convert_alpha()
                    mapnum5Button = pygame.image.load("res/mapnum/Mapnum5_0.png").convert_alpha()
                    mapnum6Button = pygame.image.load("res/mapnum/Mapnum6_1.png").convert_alpha()
                    mapinfoID = "res/mapinfo/Map" + str(modeID) + "_6info.png"
                    mapinfo = pygame.image.load(mapinfoID).convert_alpha()
                    flag_mapinfo = 6
                # shift picture
